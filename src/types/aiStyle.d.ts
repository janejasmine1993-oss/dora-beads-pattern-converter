export type AiProcessPreset = 'remove-background' | 'clean-background' | 'enhance-clarity' | 'color-optimize' | 'reduce-noise';
export type AiStylePreset = 'pixel-clean' | 'bead-pattern' | 'illustration' | 'cute-cartoon' | 'flat-icon' | 'anime-soft' | 'watercolor' | 'chinese-flower-map';
...
//# sourceMappingURL=aiStyle.d.ts.map